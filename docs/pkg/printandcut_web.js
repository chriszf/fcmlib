/* @ts-self-types="./printandcut_web.d.ts" */
 ...
 * @param {string} svg_input
 * @returns {any}
 */
export function convert(svg_input) {
    const ptr0 = passStringToWasm0(svg_input, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
...
async function __wbg_init(module_or_path) {
    ...
    if (module_or_path === undefined) {
        module_or_path = new URL('printandcut_web_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
